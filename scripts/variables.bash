...
nsidc_daily_data=$data_raw/nsidc_daily/nsidc_daily.nc
nsidc_daily_anomaly=$data_derived/nsidc_daily/nsidc_daily_anomaly.nc

hadisst_data=$data_raw/hadisst.nc
hadisst_anomaly=$data_derived/hadisst_anomaly.nc

access_subset_data=$data_derived/access_subset.nc
access_climatology=$data_derived/access_climatology.nc
access_anomaly=$data_derived/access_anomaly.nc

access_daily=$data_derived/access_daily.nc
